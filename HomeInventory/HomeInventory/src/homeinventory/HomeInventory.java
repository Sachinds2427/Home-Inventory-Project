...
JButton newButton = new JButton(new ImageIcon("resource//images//new.png"));
JButton deleteButton = new JButton(new ImageIcon("resource//images//delete.jpg"));
JButton saveButton = new JButton(new ImageIcon("resource//images//save.png"));
JButton previousButton = new JButton(new ImageIcon("resource//images//previous.png"));
JButton nextButton = new JButton(new ImageIcon("resource//images//next.png"));
JButton printButton = new JButton(new ImageIcon("resource//images//print.png"));
